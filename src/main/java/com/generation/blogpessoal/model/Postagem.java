...
// Anotaçoes: alterar ou definir comportamentos

@Entity // Definindo que a classe postagem vai se tornar uma tabela
@Table(name = "tb_postagens") // definir o nome da tabela seguindo a nossa nomeclatura
public class Postagem {

		@Id // Defini a chave primaria
		@GeneratedValue(strategy = GenerationType.IDENTITY) // defini que o campo é preenchido pelo banco de dados
		private Long id;
